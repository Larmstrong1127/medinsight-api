...
resource "aws_ecs_task_definition" "api" {
  ...
  container_definitions = jsonencode([{
    ...
    secrets = [
      { name = "OPENAI_API_KEY", valueFrom = "/${var.project}/openai_api_key" },
      { name = "API_KEYS", valueFrom = "/${var.project}/api_keys" },
      { name = "ENCRYPTION_KEY", valueFrom = "/${var.project}/encryption_key" },
    ]
    logConfiguration = {
      logDriver = "awslogs"
      options = {
